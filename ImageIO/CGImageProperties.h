...
/*
	图片属性
	包括image dimensions（大小）、resolution（分辨率）、orientation（方向）
	、color profile、aperture、metering mode，focal length、creation date、keywords、caption等等
 */
...
IMAGEIO_EXTERN const CFStringRef kCGImagePropertyExifAuxDictionary  IMAGEIO_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_4_0);//Exif信息
 ...
 * is a CFNumberRef. */
/*
	其中获取到的kCGImagePropertyPixelHeight和kCGImagePropertyPixelHeight的数值是原始的值，也就是旋转之前的数值，
	所以要获取到显示图像的宽和高，需要对应kCGImagePropertyOrientation的值，而通过查看kCGImagePropertyOrientation的文档介绍
 */
IMAGEIO_EXTERN const CFStringRef kCGImagePropertyPixelHeight  IMAGEIO_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);//像素的高
IMAGEIO_EXTERN const CFStringRef kCGImagePropertyPixelWidth  IMAGEIO_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0); //像素的宽
...
IMAGEIO_EXTERN const CFStringRef kCGImagePropertyOrientation  IMAGEIO_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);//图像的选择方向
