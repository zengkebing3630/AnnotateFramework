...
CB_EXTERN_CLASS @interface CBDescriptor : CBAttribute //服务描述符
 ...
 *
 */
@property(weak, readonly, nonatomic) CBCharacteristic *characteristic; //特征 标示属于哪个特征的
 ...
 *
 */
@property(retain, readonly) id value;//描述符数据
...
CB_EXTERN_CLASS @interface CBMutableDescriptor : CBDescriptor //可变描述符
 ...
 *
 */
- (instancetype)initWithType:(CBUUID *)UUID value:(id)value NS_DESIGNATED_INITIALIZER; //初始化描述符
